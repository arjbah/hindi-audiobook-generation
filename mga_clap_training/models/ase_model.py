...
class ASE(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.logit_scale = nn.Parameter(torch.ones([]) * math.log(1 / config["temp"]))
    ...
    def forward(self, audio, text, idx):
        ...
        global_sim_a2t = logit_scale * (audio_embeds @ text_embeds.t())
        global_sim_t2a = logit_scale * (text_embeds @ audio_embeds.t())
