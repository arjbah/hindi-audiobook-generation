...
def a2t(audio_embs, cap_embs, return_ranks=False):
    ...
    mAP = np.mean(1 / (ranks + 1))
    medr = np.floor(np.median(ranks)) + 1
    meanr = ranks.mean() + 1
    if return_ranks:
        return r1, r5, r10, r50, medr, meanr, mAP, ranks, top1
    else:
        return r1, r5, r10, r50, medr, meanr, mAP
...
def t2a(audio_embs, cap_embs, return_ranks=False):
    ...
    for index in range(num_audios):
        ...
        # get query captions
        queries = cap_embs[index:index + 1]
